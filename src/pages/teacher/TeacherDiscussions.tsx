      ...
      <div className="space-y-5">
        ...
        {loading ? (
          ...
          <EmptyState
            ...
            description="When students post questions or discussions, they'll appear here."
          />
        ) : (
          <div className="space-y-3">
            {discussions.map(d => {
              ...
              return (
                <div key={d.id} className={`card p-4 ${d.is_pinned ? 'border-l-4 border-l-sky-500' : ''}`}>
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-start gap-3 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-0.5">
                          ...
                          {d.is_pinned && <span className="text-xs bg-sky-100 dark:bg-sky-900/30 text-sky-700 dark:text-sky-400 px-2 py-0.5 rounded-full">Pinned</span>}
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      <button onClick={() => handlePin(d)} className={`p-1.5 rounded-lg transition-colors ${d.is_pinned ? 'text-sky-500' : 'text-gray-400 hover:bg-gray-100 dark:hover:bg-navy-700'}`}>
