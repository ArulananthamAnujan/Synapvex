...
export default function BookOnline() {
  return <div className="public-glass-page min-h-screen bg-white text-slate-950"><PublicHeader /><main className="pt-20">
    <section className="premium-page-hero py-24 sm:py-32"><div className="corporate-grid absolute inset-0 opacity-30" aria-hidden="true" /><img src="/images/company/project-conversation.webp" alt="A focused client conversation connected to a practical technology plan" className="absolute inset-y-0 right-0 h-full w-[60%] object-cover opacity-[0.18] [mask-image:linear-gradient(to_left,black,transparent)]" /><div className="relative mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1fr_0.72fr] lg:items-end lg:px-8"><div><p className="text-xs font-bold uppercase tracking-[0.2em] text-sky-800">Start a project</p><h1 className="mt-5 max-w-4xl font-display text-5xl font-semibold leading-[1.05] tracking-[-0.045em] text-[#102d48] sm:text-7xl">Begin with a focused conversation.</h1></div><p className="max-w-xl text-lg leading-8 text-slate-600 lg:justify-self-end">Tell us what you are trying to change. We will route your enquiry to the right capability and agree a useful next step—without a sales script.</p></div></section>
