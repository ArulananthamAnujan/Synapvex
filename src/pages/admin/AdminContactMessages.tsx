...
import { MessageSquare, Search, CheckCircle2, Clock, Mail, User, Calendar, ChevronDown, ChevronUp } from 'lucide-react';
...
export default function AdminContactMessages() {
  ...
  return (
    <DashboardLayout navItems={adminNavItems} title="Contact Messages" subtitle="All messages submitted through the contact form">
